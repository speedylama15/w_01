  ...
  content: [
    {
      type: "paragraph",
      attrs: {
        id: "14b4f005-9e5a-4612-b832-1d218a4b2e8a",
      ...
      content: [
        {
          type: "text",
          text: "This is the thing about this is that this can get very complicated and also very extreme",
        },
      ],
    },
    {
      type: "paragraph",
      attrs: {
        id: "c9611609-eba5-4e89-bfc7-913c73fde2c2",
        contentType: "paragraph",
        indentLevel: 0,
        nodeType: "block",
      },
      content: [
        {
          type: "text",
          text: "- Hopefully the performance is good",
        },
      ],
    },
    {
      type: "paragraph",
      attrs: {
        id: "10a54c6f-d525-4483-9477-cb52797bb53a",
        contentType: "paragraph",
        indentLevel: 0,
        nodeType: "block",
      },
      content: [
        {
          type: "text",
          text: "There are many things that it may need to render.",
        },
      ],
    },
    {
      type: "paragraph",
      attrs: {
        id: "3f681df9-f924-418d-bfa4-9477c7afa931",
        contentType: "paragraph",
        indentLevel: 0,
        nodeType: "block",
      },
    ...
    },
    {
      type: "paragraph",
      attrs: {
        id: "c7a278f4-a5e0-48cb-a1fe-d209e33e5e85",
        contentType: "paragraph",
        indentLevel: 0,
        nodeType: "block",
      },
      content: [
        {
          type: "text",
          text: "Maybe I should use a markdown?",
        },
        {
          type: "hardBreak",
        },
        {
          type: "text",
          text: "But the issue with a Markdown is that there are 2 versions in which it is able to render",
        },
      ],
    },
  ],
